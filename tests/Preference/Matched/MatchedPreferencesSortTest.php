...
class MatchedPreferencesSortTest extends \PHPUnit_Framework_TestCase
{
    public function testGetAscendingOne()
    {
        ...
        $typePairList[] = new MatchedPreferences(
            new Preference('en-gb', 0.9, Preference::EXACT_TYPE),
            new Preference('en-gb', 1, Preference::EXACT_TYPE)
        );
        $typePairList[] = new MatchedPreferences(
            new Preference('fr', 0.8, Preference::EXACT_TYPE),
            new Preference('fr', 0.8, Preference::EXACT_TYPE)
        );
    ...
    public function testGetAscendingThree()
    {
        $typePairList = array();
        $typePairList[] = new MatchedPreferences(
            new Preference('en-gb', 0.8, Preference::EXACT_TYPE),
            new Preference('en-gb', 0.9, Preference::EXACT_TYPE)
        );
        $typePairList[] = new MatchedPreferences(
            new Preference('fr', 0.8, Preference::EXACT_TYPE),
            new Preference('fr', 0.9, Preference::EXACT_TYPE)
        );
